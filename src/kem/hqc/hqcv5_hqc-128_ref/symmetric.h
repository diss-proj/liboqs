...
void hash_g(uint8_t *output, const uint8_t h_ek[hqcv5_128_SEED_BYTES], const uint8_t m[hqcv5_128_VEC_K_SIZE_BYTES],
            const uint8_t salt[hqcv5_128_SALT_BYTES]);
void hash_h(uint8_t *output, const uint8_t pk[hqcv5_128_PUBLIC_KEY_BYTES]);
void hash_i(uint8_t *output, const uint8_t *seed);
void hash_j(uint8_t *output, const uint8_t h_ek[hqcv5_128_SEED_BYTES], const uint8_t sigma[hqcv5_128_VEC_K_SIZE_BYTES],
