...
int main(void) {
    ...
    unsigned char ct[hqcv5_128_CRYPTO_CIPHERTEXTBYTES] = {0};
    unsigned char ss[hqcv5_128_CRYPTO_BYTES] = {0};
    unsigned char ss1[hqcv5_128_CRYPTO_BYTES] = {0};
    int count;
    int done;
    unsigned char pk[hqcv5_128_CRYPTO_PUBLICKEYBYTES] = {0};
    unsigned char sk[hqcv5_128_CRYPTO_SECRETKEYBYTES] = {0};
    int ret_val;

    // Create the REQUEST file
    sprintf(fn_req, "PQCkemKAT_%d.req", hqcv5_128_CRYPTO_SECRETKEYBYTES);
    if ((fp_req = fopen(fn_req, "w")) == NULL) {
        printf("Couldn't open <%s> for write\n", fn_req);
        return KAT_FILE_OPEN_ERROR;
    }
    sprintf(fn_rsp, "PQCkemKAT_%d.rsp", hqcv5_128_CRYPTO_SECRETKEYBYTES);
    ...
    do {
        ...
        fprintBstr(fp_rsp, "ss = ", ss, hqcv5_128_CRYPTO_BYTES);
