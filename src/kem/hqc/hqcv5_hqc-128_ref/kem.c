 ...
 * @return 0 on success.
 *
 * @pre The PRNG **must be seeded** with ::hqcv5_128_prng_init() before calling this function.
 * @warning This function calls ::hqcv5_128_prng_get_bytes() to sample `seed_kem`. If the PRNG has not been
 ...
 * @see hqcv5_128_prng_init, hqcv5_128_prng_get_bytes, main_hqc.c
 */
int hqcv5_128_crypto_kem_keypair(uint8_t *ek_kem, uint8_t *dk_kem) {
    ...
    hqcv5_128_shake256_xof_ctx ctx_kem;

    uint8_t ek_pke[hqcv5_128_PUBLIC_KEY_BYTES] = {0};
    uint8_t dk_pke[hqcv5_128_SEED_BYTES] = {0};

    // Sample seed_kem
    hqcv5_128_prng_get_bytes(seed_kem, hqcv5_128_SEED_BYTES);

    // Compute seed_pke and randomness sigma
    hqcv5_128_xof_init(&ctx_kem, seed_kem, hqcv5_128_SEED_BYTES);
    hqcv5_128_xof_get_bytes(&ctx_kem, seed_pke, hqcv5_128_SEED_BYTES);
    hqcv5_128_xof_get_bytes(&ctx_kem, sigma, hqcv5_128_PARAM_SECURITY_BYTES);
...
int hqcv5_128_crypto_kem_enc(uint8_t *c_kem, uint8_t *K, const uint8_t *ek_kem) {
    ...
    hqcv5_128_prng_get_bytes(m, hqcv5_128_PARAM_SECURITY_BYTES);
    hqcv5_128_prng_get_bytes(c_kem_t.salt, hqcv5_128_SALT_BYTES);

    // Compute shared key K and ciphertext c_kem
    hqcv5_128_hash_h(hash_ek_kem, ek_kem);
    hqcv5_128_hash_g(K_theta, hash_ek_kem, m, c_kem_t.salt);
...
int hqcv5_128_crypto_kem_dec(uint8_t *K_prime, const uint8_t *c_kem, const uint8_t *dk_kem) {
    ...
    hqcv5_128_hash_h(hash_ek_kem, ek_pke);
    hqcv5_128_hash_g(K_theta_prime, hash_ek_kem, m_prime, c_kem_t.salt);
    ...
    hqcv5_128_hash_j(K_bar, hash_ek_kem, sigma, &c_kem_t);
