 ...
 */
void hqcv5_128_hqc_c_kem_to_string(uint8_t *ct, const hqcv5_128_ciphertext_kem_t *c_kem) {
    memcpy(ct, c_kem->c_pke.u, hqcv5_128_VEC_N_SIZE_BYTES);
    memcpy(ct + hqcv5_128_VEC_N_SIZE_BYTES, c_kem->c_pke.v, hqcv5_128_VEC_N1N2_SIZE_BYTES);
    memcpy(ct + hqcv5_128_VEC_N_SIZE_BYTES + hqcv5_128_VEC_N1N2_SIZE_BYTES, c_kem->salt, hqcv5_128_SALT_BYTES);
}
 ...
 */
void hqcv5_128_hqc_c_kem_from_string(hqcv5_128_ciphertext_pke_t *c_pke, uint8_t *salt, const uint8_t *ct) {
    memcpy(c_pke->u, ct, hqcv5_128_VEC_N_SIZE_BYTES);
    memcpy(c_pke->v, ct + hqcv5_128_VEC_N_SIZE_BYTES, hqcv5_128_VEC_N1N2_SIZE_BYTES);
    memcpy(salt, ct + hqcv5_128_VEC_N_SIZE_BYTES + hqcv5_128_VEC_N1N2_SIZE_BYTES, hqcv5_128_SALT_BYTES);
}
