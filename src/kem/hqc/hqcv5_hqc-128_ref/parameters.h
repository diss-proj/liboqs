...
#define SECRET_KEY_BYTES            hqcv5_128_CRYPTO_SECRETKEYBYTES   ///< Define the size of the secret key in bytes
#define PUBLIC_KEY_BYTES            hqcv5_128_CRYPTO_PUBLICKEYBYTES   ///< Define the size of the public key in bytes
#define SHARED_SECRET_BYTES         hqcv5_128_CRYPTO_BYTES            ///< Define the size of the shared secret in bytes
#define CIPHERTEXT_BYTES            hqcv5_128_CRYPTO_CIPHERTEXTBYTES  ///< Define the size of the ciphertext in bytes
