 ...
 */
void hqcv5_256_vect_generate_random_support1(hqcv5_256_shake256_xof_ctx *ctx, uint32_t *support, uint16_t weight) {
    ...
    while (i < weight) {
        do {
            if (j == random_bytes_size) {
                hqcv5_256_xof_get_bytes(ctx, rand_bytes, random_bytes_size);
                j = 0;
            }
 ...
 */
void hqcv5_256_vect_generate_random_support2(hqcv5_256_shake256_xof_ctx *ctx, uint32_t *support, uint16_t weight) {
    uint32_t rand_u32[hqcv5_256_PARAM_OMEGA_R] = {0};

    hqcv5_256_xof_get_bytes(ctx, (uint8_t *)&rand_u32, 4 * weight);
 ...
 * @param[in]     weight  Desired Hamming weight.
 */
void hqcv5_256_vect_sample_fixed_weight1(hqcv5_256_shake256_xof_ctx *ctx, uint64_t *v, uint16_t weight) {
 ...
 * @param[in]     weight  Desired Hamming weight.
 */
void hqcv5_256_vect_sample_fixed_weight2(hqcv5_256_shake256_xof_ctx *ctx, uint64_t *v, uint16_t weight) {
    uint32_t support[hqcv5_256_PARAM_OMEGA_R] = {0};
 ...
 */
void hqcv5_256_vect_set_random(hqcv5_256_shake256_xof_ctx *ctx, uint64_t *v) {
    hqcv5_256_xof_get_bytes(ctx, (uint8_t *)v, hqcv5_256_VEC_N_SIZE_BYTES);
